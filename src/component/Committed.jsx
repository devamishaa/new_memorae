...
const Committed = () => {
    ...
    const handleNext = () => {
        navigate('/step-one'); // Navigate back to Hero
    };
    return (
        <>
            <div
                            ...
                            <div className="flex flex-col gap-2 text-left">
                                <Pill icon={memoraeLogo} text="MEMORAE" />
                                 <p className="font-medium">
                                    ¡Me encanta que te hayas comprometido!
                                    <br />
                                    <br />
                                    Que sepas que otras 10,000 personas también lo han hecho, y tú eres una de ellas.
                                </p>
                            </div>
                        </ChatBubble>
                ...
                <div className=" relative z-20 h-full items-end justify-center px-6 lg:px-20 pt-[130px]">
                    ...
                    <div className="flex justify-center mt-8">
                        <Button
                            ...
                            className="hover:opacity-90 leading-[1.4] text-white"
                        />
                    </div>
